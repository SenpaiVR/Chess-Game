...
function Piece({ isPremovedPiece = false, piece, square, squares }) {
  ...
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ ref: arePiecesDraggable ? canDrag ? drag : null : null, onClick: () => onPieceClick(piece, square), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? chessPieces[piece]({
    squareWidth: boardWidth / 8,
    isDragging,
    square
  }) : (0, import_jsx_runtime.jsx)("svg", Object.assign({ viewBox: "1 1 43 43", width: boardWidth / 8, height: boardWidth / 8 }, { children: (0, import_jsx_runtime.jsx)("g", { children: chessPieces[piece] }) })) }));
}
function Square({ square, squareColor, setSquares, squareHasPremove, children }) {
  ...
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ ref: drop, style: defaultSquareStyle, "data-square-color": squareColor, "data-square": square, onMouseOver: (e) => {
...
var Chessboard = (0, import_react.forwardRef)((props, ref) => {
  ...
  return backendSet && clientWindow ? (0, import_jsx_runtime.jsx)(ErrorBoundary, { children: (0, import_jsx_runtime.jsxs)("div", Object.assign({ ref: boardContainerRef, style: {
    display: "flex",
    flexDirection: "column",
    width: "100%"
  } }, { children: [(0, import_jsx_runtime.jsx)("div", { ref: boardRef, style: { width: "100%" } }), (0, import_jsx_runtime.jsx)(DndProvider, Object.assign({ backend, context: clientWindow, options: customDndBackend ? customDndBackendOptions : void 0 }, { children: boardWidth && (0, import_jsx_runtime.jsxs)(ChessboardProvider, Object.assign({ boardWidth }, otherProps, { ref }, { children: [(0, import_jsx_runtime.jsx)(CustomDragLayer, { boardContainer: boardContainerPos }), (0, import_jsx_runtime.jsx)(Board, {})] })) }))] })) }) : null;
});
export {
  Chessboard
};
